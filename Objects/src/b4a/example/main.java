...
public b4a.example.start _start = null;

public static boolean isAnyActivityVisible() {
    boolean vis = false;
vis = vis | (main.mostCurrent != null);
vis = vis | (start.mostCurrent != null);
return vis;}
...
public static String  _btnproceed_click() throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub btnProceed_Click";
 //BA.debugLineNum = 45;BA.debugLine="StartActivity(start)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._start.getObject()));
 //BA.debugLineNum = 46;BA.debugLine="End Sub";
return "";
}
public static String  _globals() throws Exception{
 //BA.debugLineNum = 21;BA.debugLine="Sub Globals";
 //BA.debugLineNum = 25;BA.debugLine="Private btnProceed As Button";
